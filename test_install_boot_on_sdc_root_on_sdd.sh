...
./install_gentoo.sh --force --boot-device /dev/sdc --root-device /dev/sdd --boot-device-partition-table gpt --root-device-partition-table gpt --boot-filesystem ext4 --root-filesystem ext4 --c-std-lib glibc --hostname glibc64gbusb --march nocona
